...
/*   Updated: 2022/03/16 00:00:48 by dkoriaki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Cat::Cat(Cat const & src) : AAnimal(), _brain(new Brain(*src._brain)) //_brain(src._brain) remove comment to explain the deep copy
{
